    ...
    <>
      ...
      <section className="kids-intro">
        <div className="container kids-intro-inner">
          <div className="kids-intro-copy reveal-stagger">
            <span className="eyebrow reveal">Our Heart</span>
            <h2 className="reveal">Helping kids discover <em>Christ in them</em>.</h2>
            <p className="lead reveal">More than just childcare. From nursery through 4th grade we aim to build meaningful relationships with each child &mdash; pointing them, week after week, toward a life rooted in Christ.</p>
            <p className="reveal">Guided by our motto &mdash; <strong>Love. Grow. Serve. Go.</strong> &mdash; every moment in Hope Kids is intentional. We partner with parents and guardians to walk alongside families as they shepherd their children in faith.</p>
          </div>
          <div className="kids-intro-photo reveal-fade">
        ...
        <div className="container">
          <div className="kids-pillars reveal-stagger">
            {pillars.map(p => (
              <div className="kids-pillar reveal" key={p.word} style={{'--pillar-color': p.color}}>
      ...
      <section className="kids-foundation">
        <div className="container kids-foundation-inner">
          <div className="kids-foundation-logo reveal-fade">
            <img src="assets/hopekids-logo.png" alt="Hope Kids — Love. Grow. Serve. Go."/>
          </div>
          <div className="kids-foundation-copy reveal-stagger">
            <span className="eyebrow reveal">Building a Strong Foundation</span>
            <h2 className="reveal">A Biblical foundation for the next generation.</h2>
            <p className="reveal">There&rsquo;s nothing more important than investing in the spiritual growth of our next generation. Our mission is to help children build a solid, lasting Biblical foundation &mdash; one that will carry them through every stage of life and into adulthood with confidence in their faith.</p>
            <p className="reveal">To support this, we use the <strong>&lsquo;Hyfi&rsquo; curriculum by Lifeway</strong> &mdash; a Christ-centered tool that helps kids understand the Bible as a unified story. As they move through our ministry from early childhood onward, they&rsquo;ll journey through the entire Bible multiple times with engaging lessons, creative activities, and hands-on crafts designed to deepen their understanding and love for God&rsquo;s Word.</p>
            <p className="kids-foundation-coda reveal">Together, we&rsquo;re raising up a generation that knows God, loves His Word, and boldly lives out His truth.</p>
          </div>
        </div>
      </section>
      ...
      <section className="kids-sundays">
        <div className="container">
          <header className="kids-section-head reveal-stagger">
            <span className="eyebrow reveal">Sunday Mornings</span>
            <h2 className="reveal">A fun, safe, Christ-centered space for every age.</h2>
            <div className="kids-service-times reveal">
          ...
          <div className="kids-ages reveal-stagger">
            {ages.map((a, i) => (
              <article className="kids-age-card reveal" key={a.title}>
          ...
          <div className="kids-checkin-note reveal">
      ...
      <section className="kids-gallery-section">
        <div className="container">
          <header className="kids-section-head kids-section-head-center reveal-stagger">
            <span className="eyebrow reveal">Inside Hope Kids</span>
            <h2 className="reveal">A whole lot of learning, laughter, and lifelong friendships.</h2>
          </header>
          <div className="kids-gallery reveal-stagger">
            {gallery.map((g, i) => (
              <figure className={`kids-gallery-item kids-gallery-${g.span} reveal-fade`} key={i}>
      ...
      <section className="kids-safety">
        <div className="container kids-safety-inner">
          <div className="kids-safety-copy reveal-stagger">
            <span className="eyebrow reveal">Safety First</span>
            <h2 className="reveal">Committed to your child&rsquo;s safety.</h2>
            <p className="reveal">At Hope Church, the safety and well-being of every child in our care is a top priority. We&rsquo;re committed to providing a secure environment where families can feel confident and kids can thrive.</p>
            <p className="reveal">You can relax knowing your child is not only learning and growing &mdash; but is also in safe, trusted hands.</p>
          </div>
          <ul className="kids-safety-list reveal-stagger">
            {safety.map(s => (
              <li className="reveal" key={s.t}>
      ...
      <section className="kids-calendar">
        <div className="container">
          <header className="kids-section-head kids-section-head-center reveal-stagger">
            <span className="eyebrow reveal">What&rsquo;s Coming Up</span>
            <h2 className="reveal">The Hope Kids calendar.</h2>
            <p className="reveal">Family events, kids&rsquo; nights, and special Sundays &mdash; everything happening in Hope Kids, pulled live so you never miss a thing.</p>
          </header>
          <div className="kids-calendar-frame reveal">
      ...
      <section className="kids-cta-band">
        <div className="container reveal-stagger">
          <span className="eyebrow reveal">Parents</span>
          <h2 className="reveal">Serve alongside your kids.</h2>
          <p className="reveal">We invite and encourage parents to serve in Hope Kids on a rotating basis. There are many ways to get involved &mdash; and it&rsquo;s a great way to get to know other families with young children at Hope. If you&rsquo;re new to Hope, we ask that you complete our Discover Hope class before serving.</p>
          ...
          <div className="kids-cta-back reveal-soft">
