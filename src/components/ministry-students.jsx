    ...
    <>
      ...
      <section className="hs-intro">
        <div className="container hs-intro-inner">
          <div className="hs-intro-copy reveal-stagger">
            <span className="hs-intro-eyebrow reveal">Made For Students</span>
            <h2 className="reveal">The next six years <em>matter</em>.</h2>
            <p className="lead reveal">Middle school and high school is where most students decide what they really believe. We don&rsquo;t want them to figure that out alone.</p>
            <p className="reveal">Hope Students is a place where 7th–12th graders are known by name, walked alongside by leaders who actually show up, and given room to ask the real questions. We&rsquo;re committed to pursuing the growth of <strong>every student</strong> who walks through our doors.</p>
            <div className="hs-intro-stats reveal">
              <div>
          ...
          <div className="hs-intro-media reveal-fade">
      ...
      <section className="hs-wednesday">
        <div className="container hs-wed-inner">
          <div className="hs-wed-copy reveal-stagger">
            <span className="eyebrow reveal">The Main Event</span>
            <h3 className="hs-wed-day reveal">Wednesday <em>Night.</em></h3>
            <div className="hs-wed-times reveal">
              <span className="hs-wed-times-label">Every Wed</span>
              <span className="hs-wed-times-val">6:30 – 8:00pm</span>
            </div>
            <p className="lead reveal">The whole student ministry meets at Hope Church — 7th through 12th, together in one room.</p>
            <p className="reveal">Every gathering includes worship, a message, small group time, and a whole lot of fun. It&rsquo;s the night of the week most of our students bring a friend.</p>
          </div>
          <div className="hs-beats reveal-stagger">
            {beats.map((b) => (
              <article className="hs-beat reveal" key={b.n}>
      ...
      <section className="hs-sunday">
        <div className="container hs-sunday-inner">
          <div className="hs-sunday-copy reveal-stagger">
            <span className="eyebrow reveal">Sunday Mornings</span>
            <h2 className="reveal">Worship with us, <em>every weekend</em>.</h2>
            <p className="reveal">Hope Students worships with the whole church in the auditorium on Sunday mornings. Sit with your family, find your friends, or grab a leader — there&rsquo;s a row saved for you.</p>
            <div className="hs-sunday-times reveal">
          ...
          <div className="hs-sunday-photo reveal-fade">
      ...
      <section className="hs-gallery">
        <div className="container">
          <header className="hs-gallery-head reveal-stagger">
            <span className="eyebrow reveal">A Glimpse Inside</span>
            <h2 className="reveal">This is what <em>showing up</em> looks like.</h2>
            <p className="reveal">Worship nights, prayer circles, small groups, dress-up themes — every part of Hope Students is built around real students walking with Jesus and with each other.</p>
          </header>
          <div className="hs-mosaic reveal-stagger">
            <figure className="hs-mosaic-item tall reveal-fade">
            ...
            <figure className="hs-mosaic-item small1 reveal-fade">
            ...
            <figure className="hs-mosaic-item small2 reveal-fade">
            ...
            <figure className="hs-mosaic-item wide reveal-fade">
      ...
      <section className="hs-calendar">
        <div className="container">
          <header className="hs-calendar-head reveal-stagger">
            <span className="eyebrow reveal">What&rsquo;s Coming Up</span>
            <h2 className="reveal">The Hope Students calendar.</h2>
            <p className="reveal">Wednesday nights, retreats, service days, and the rest — everything happening in Hope Students, pulled live so you never miss a thing.</p>
          </header>
          <div className="hs-calendar-frame reveal">
      ...
      <section className="hs-cta-band">
        ...
        <div className="container reveal-stagger" style={{position:'relative', zIndex:1}}>
          <span className="eyebrow reveal">Get Involved</span>
          <h2 className="reveal">Bring a friend. <em>Or come walk with them.</em></h2>
          <p className="reveal">Students &mdash; everything you need lives on our Linktree (info, sign-ups, hangouts, group chats). Adults &mdash; we&rsquo;re always looking for leaders who&rsquo;ll show up and know our students by name.</p>
          ...
          <div className="hs-cta-back reveal-soft">
