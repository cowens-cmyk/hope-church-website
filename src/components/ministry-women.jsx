    ...
    <>
      ...
      <section className="wv-anchor">
        <div className="container wv-anchor-inner">
          <div className="wv-anchor-copy reveal-stagger">
            <div className="wv-anchor-mark reveal">
              <img src="assets/woven-logo-blue.png" alt="Woven — Women of Hope"/>
            </div>
            <span className="wv-anchor-eyebrow reveal">A Ministry of Hope Church</span>
            <h1 className="reveal">Joined and <em>knit together</em>.</h1>

            <p className="wv-anchor-mission reveal">
            ...
            <blockquote className="wv-verse reveal">
          ...
          <div className="wv-anchor-media reveal-fade">
      ...
      <section className="wv-rhythms">
        <div className="container">
          <header className="wv-rhythms-head reveal-stagger">
            <span className="wv-eyebrow reveal">How We Grow Together</span>
            <h2 className="reveal">Three rhythms that <em>shape Woven</em>.</h2>
            <p className="reveal">None of them require a special invitation &mdash; just a willingness to show up once and see.</p>
          </header>
          <div className="wv-rhythms-grid reveal-stagger">
            {rhythms.map((r, i) => (
              <article className="wv-rhythm reveal" key={r.n}>
      ...
      <section className="wv-knit">
        <div className="wv-knit-grid">
          <div className="wv-knit-photo reveal-fade">
            <img src="assets/woven-retreat-porch.jpg" alt="The Woven women's retreat group gathered together on a cabin porch at night"/>
          </div>
          <div className="wv-knit-copy reveal-stagger">
            <span className="wv-eyebrow reveal">Every Season</span>
            <h2 className="reveal">For the season you&rsquo;re <em>actually in</em>.</h2>
            <p className="reveal">
      ...
      <section className="wv-calendar">
        <div className="container">
          <header className="wv-calendar-head reveal-stagger">
            <span className="wv-eyebrow reveal">What&rsquo;s Coming Up</span>
            <h2 className="reveal">The Woven <em>calendar</em>.</h2>
            <p className="reveal">Bible studies, brunches, retreats, and prayer gatherings &mdash; everything happening in Woven, pulled live so you never miss a thing.</p>
          </header>
          <div className="wv-calendar-frame reveal">
      ...
      <section className="wv-cta-band">
        <div className="container reveal-stagger">
          <span className="wv-eyebrow reveal">Get Connected</span>
          <h2 className="reveal">Come find <em>your people</em>.</h2>
          <p className="reveal">The Woven Facebook group is where week-of details, prayer requests, and last-minute brunches all live. Hop in, introduce yourself, and we&rsquo;ll see you soon.</p>
          ...
          <div className="wv-cta-back reveal-soft">
