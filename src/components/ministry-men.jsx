    ...
    <>
      ...
      <section className="mn-anchor">
        <div className="container mn-anchor-inner">
          <div className="mn-anchor-copy reveal-stagger">
            <span className="mn-anchor-eyebrow reveal">A Ministry of Hope Church</span>

            <h1 className="reveal">Honor. Integrity. <em>Transformation</em>.</h1>

            <p className="mn-anchor-mission reveal">
            ...
            <blockquote className="mn-verse reveal">
            ...
            <blockquote className="mn-lewis reveal">
          ...
          <div className="mn-anchor-media reveal-fade" aria-hidden="false">
      ...
      <section className="mn-pillars">
        <div className="container">
          <header className="mn-pillars-head reveal-stagger">
            <span className="mn-eyebrow reveal">What H.I.T. stands for</span>
            <h2 className="reveal">Three words we&rsquo;re <em>actually trying to live</em>.</h2>
            <p className="reveal">None of these come easy on your own. That&rsquo;s the whole point of doing it together.</p>
          </header>
          <div className="mn-pillars-grid reveal-stagger">
            {pillars.map(p => (
              <article className="mn-pillar reveal" key={p.letter}>
      ...
      <section className="mn-meets">
        <div className="container">
          <header className="mn-meets-head reveal-stagger">
            <span className="mn-eyebrow reveal">Small Group Opportunities</span>
            <h2 className="reveal">Two ways to <em>get around the table</em>.</h2>
            <p className="reveal">The Men&rsquo;s Ministry runs two weekly groups so there&rsquo;s a rhythm that fits your week. Same heart, different schedule &mdash; pick one and show up once.</p>
          </header>

          <div className="mn-meets-grid reveal-stagger">
            {meets.map((m, i) => (
              <article className="mn-meet reveal" key={m.title}>
                <div
      ...
      <section className="mn-calendar">
        <div className="container">
          <header className="mn-calendar-head reveal-stagger">
            <span className="mn-eyebrow reveal">What&rsquo;s Coming Up</span>
            <h2 className="reveal">The H.I.T. Men <em>calendar</em>.</h2>
            <p className="reveal">Studies, breakfasts, service days, and the occasional cookout &mdash; pulled live so you never miss a thing.</p>
          </header>
          <div className="mn-calendar-frame reveal">
      ...
      <section className="mn-cta-band">
        <div className="container reveal-stagger">
          <span className="mn-eyebrow reveal">Get Connected</span>
          <h2 className="reveal">Pull up <em>a chair</em>.</h2>
          <p className="reveal">The H.I.T. Men Facebook group is where the week-of details, prayer requests, and last-minute plans all live. Hop in, say hello, and we&rsquo;ll see you Monday or Tuesday.</p>
          ...
          <div className="mn-cta-back reveal-soft">
